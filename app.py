...
dividendo = st.sidebar.number_input("Dividendo esperado (D1)", value=1.0, step=0.1)
g = st.sidebar.number_input("Tasa de crecimiento del dividendo (%)", value=2.0, step=0.1)
precio = st.sidebar.number_input("Precio de la acción (P)", value=50.0, step=0.1)

# Botón para correr el cálculo
if st.sidebar.button("Calcular Costo de Capital (Ke)"):
    # Fórmula Gordon Growth Model: Ke = (D1 / P) + g
    ke = (dividendo / precio) + (g / 100)
